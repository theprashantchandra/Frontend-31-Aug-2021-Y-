...
<Grid container spacing={1.25} my={5}>
      ...
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary">
          ...
          <div className={classes.links}>
          <li>
            <Link href='/handbook/onboarding' onClick={handleClick} variant='h15' color='primary'>Onboarding</Link>
            
            </li>
          <li><Link href='/b' variant='body2'>Cloud Subscription</Link></li>
          <li><Link href='#' variant='body2'>Trial</Link></li>
          <li><Link href='#' variant='body2'>Trial</Link></li>
          <li><Link href='#' variant='body2'>Trial</Link></li>
...
export default FrontPageSecure
